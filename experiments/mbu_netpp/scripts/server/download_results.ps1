param(
    ...
    [string]$RemoteArchiveRelative = "results/server_delivery/merged_real77_final_infer_100.tar.gz",
    [string]$LocalOutputParent = "D:\中期\wd_bishe\results",
    [string]$ResultName = "merged_real77_final_infer_100"
)
...
Write-Host "叠加图目录: $(Join-Path $localExtractDir 'overlays')"
