param(
    ...
    [int]$Port = 22,
    [string]$IdentityFile = "",
    [string]$RemoteRoot = "/home/ubuntu/wd_bishe_server",
    ...
    [string]$LocalNasaPrepared = "C:\Users\pyd111\Desktop\prepared_nasa_super_secondary_train",
    ...
    [string]$BundleName = "merged_real77_server_bundle.tar.gz",
    [switch]$ResetRemote
)
...
$tmpRoot = Join-Path $resolvedRepoRoot "tmp\server_bundle_build"
...
Copy-IntoBundle -SourcePath $LocalRealSourceA -DestinationRelative "server_assets\training_sources\analysis_real26"
Copy-IntoBundle -SourcePath $LocalRealSourceB -DestinationRelative "server_assets\training_sources\refined_real16"
Copy-IntoBundle -SourcePath $LocalNasaPrepared -DestinationRelative "server_assets\training_sources\prepared_nasa_super_secondary_train"
...
Write-Host "  bash $RemoteRoot/experiments/mbu_netpp/scripts/server/run_merged_real77_pipeline.sh"
