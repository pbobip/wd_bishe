param(
    ...
    [string]$LocalAuxPreparedRoot = "C:\Users\pyd111\Desktop\prepared_nasa_super_secondary_train",
    ...
    [string]$BundleName = "opt_real53_suite_bundle.tar.gz",
    [switch]$ResetRemote
)
...
$tmpRoot = Join-Path $resolvedRepoRoot "tmp\server_bundle_build_opt_suite"
...
Copy-IntoBundle -SourcePath $LocalAuxPreparedRoot -DestinationRelative "server_assets\prepared_sources\nasa_secondary"
...
Write-Host "  bash experiments/mbu_netpp/scripts/server/run_opt_training_suite.sh"
