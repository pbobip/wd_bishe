...
if __name__ == '__main__':
    # Define input tensor (e.g., batch_size=1, channels=16, height=64, width=64)
    input_tensor = torch.randn(1, 16, 64, 64)

    # Instantiate LAE (Light-weight Adaptive Extraction)
    lae = LAE(ch=16)

    # Pass the input tensor through the LAE module
    output_tensor = lae(input_tensor)
