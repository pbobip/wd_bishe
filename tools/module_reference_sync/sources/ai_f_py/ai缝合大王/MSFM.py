...
# Multipath Shunt Feature Matching (MSFM)
...
if __name__ == '__main__':
    # Define input tensor (e.g., batch_size=2, channels=64, height=128, width=128)
    input_tensor = torch.randn(2, 64, 128, 128)

    # Instantiate MSFM (Multi-Scale Feature Module)
    msfm = MSFM(c1=64, c2=128)

    # Pass the input tensor through the MSFM module
    output_tensor = msfm(input_tensor)
